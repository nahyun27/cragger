-- 색깔 구성 제보 — gym_submissions.changes.add_colors / remove_colors 배열 처리.
--
-- changes JSONB 예:
--   { "add_colors": ["yellow", "navy"], "remove_colors": ["gray"] }
--
-- 트리거 승인 시: 해당 gym 의 gym_color_schemes 행 INSERT / DELETE.
-- add_colors 의 color 가 이미 등록돼있으면 무시 (idempotent).
...
begin
  ...
  -- ─── 색깔 구성 변경 (add_colors / remove_colors) ──────────
