...
export const BADGES: BadgeDef[] = [
  ...
  { key: 'color_master',  category: 'record', name: '컬러 마스터', hint: '한 세션에 5색 이상 완등', icon: 'palette', color: '#7c3aed', bg: '#ede9fe' },

  // ── 그레이드 (grade) ───────────────────────────────────────
  { key: 'first_v0',      category: 'grade',  name: 'V0 클라이머', hint: 'V0 이상 완등 10개', icon: 'V0', color: '#ef4444', bg: '#fef2f2' },
  { key: 'first_v1',      category: 'grade',  name: 'V1 클라이머', hint: 'V1 이상 완등 10개', icon: 'V1', color: '#f97316', bg: '#fff7ed' },
  { key: 'first_v2',      category: 'grade',  name: 'V2 클라이머', hint: 'V2 이상 완등 10개', icon: 'V2', color: '#eab308', bg: '#fefce8' },
  { key: 'first_v3',      category: 'grade',  name: 'V3 클라이머', hint: 'V3 이상 완등 10개', icon: 'V3', color: '#22c55e', bg: '#f0fdf4' },
  { key: 'first_v4',      category: 'grade',  name: 'V4 클라이머', hint: 'V4 이상 완등 10개', icon: 'V4', color: '#3b82f6', bg: '#eff6ff' },
  { key: 'first_v5',      category: 'grade',  name: 'V5 클라이머', hint: 'V5 이상 완등 10개', icon: 'V5', color: '#4f46e5', bg: '#e0e7ff' },
  { key: 'first_v6',      category: 'grade',  name: 'V6 클라이머', hint: 'V6 이상 완등 10개', icon: 'V6', color: '#a855f7', bg: '#faf5ff' },
  { key: 'first_v7',      category: 'grade',  name: 'V7 클라이머', hint: 'V7 이상 완등 10개', icon: 'V7', color: '#92400e', bg: '#fef3c7' },
  { key: 'first_v8',      category: 'grade',  name: 'V8 클라이머', hint: 'V8 이상 완등 10개', icon: 'V8', color: '#64748b', bg: '#f8fafc' },
  { key: 'first_v9',      category: 'grade',  name: 'V9 클라이머', hint: 'V9 이상 완등 10개', icon: 'V9', color: '#0f172a', bg: '#f1f5f9' },
  ...
  { key: 'report_king',   category: 'social', name: '제보 왕',     hint: '제보 10번 이상', icon: 'crown', color: '#b45309', bg: '#fef3c7' },
