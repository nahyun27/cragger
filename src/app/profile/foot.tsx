...
const SHAPE_OPTIONS: Array<{
  ...
  { value: 'egyptian', label: '이집트형', sub: '엄지발가락이 가장 김' },
  { value: 'greek', label: '그리스형', sub: '검지발가락이 가장 김' },
  { value: 'roman', label: '로마형', sub: '앞 세 발가락 길이 비슷' },
  { value: 'square', label: '정사각형', sub: '다섯 발가락 길이 거의 동일' },
];
...
const s = StyleSheet.create({
  ...
  helperText: { flex: 1, fontSize: 12, color: '#475569', lineHeight: 17 },
  ...
  shapeLabel: { fontSize: 14, fontWeight: '800', color: '#0f172a', marginBottom: 4 },
  shapeLabelActive: { color: '#0f172a' },
  shapeSub: { fontSize: 11, color: '#64748b', lineHeight: 15 },
  ...
  threeLabel: { fontSize: 14, fontWeight: '800', color: '#0f172a', marginBottom: 3 },
  threeLabelActive: { color: '#0f172a' },
  threeSub: { fontSize: 10, color: '#64748b', textAlign: 'center', lineHeight: 14 },
  footer: {
    flexDirection: 'row',
    gap: 10,
    paddingHorizontal: 16,
