    ...
    <SafeAreaView className="flex-1 bg-background-primary" edges={['top', 'bottom']}>
      ...
      >
        <View className="flex-1 px-6 justify-center gap-6">
          <Text className="text-text-primary text-3xl font-bold">가입하기</Text>
          ...
          {infoMessage && (
            <View className="border border-status-info rounded-md p-3 bg-background-secondary">
              <Text className="text-status-info">{infoMessage}</Text>
            </View>
          )}
          ...
          >
            {isSubmitting ? (
              ...
              <Text className="text-background-primary text-base font-semibold">가입하기</Text>
            )}
          </Pressable>

          <View className="flex-row justify-center gap-2">
            <Text className="text-text-secondary">이미 계정이 있으신가요?</Text>
            <Link href="/auth/sign-in" className="text-brand-primary font-semibold">
              로그인
            </Link>
          </View>
        </View>
